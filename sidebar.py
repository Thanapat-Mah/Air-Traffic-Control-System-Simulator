...
class Sidebar:
	...
	def update_information(self, overall_plane_information, airport_information, selected_object_detail):
		...
		self.__overall_list_box.update_button(airport_status_list=airport_status_list)
