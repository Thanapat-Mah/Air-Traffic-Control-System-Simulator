...
class Screen:
	...
	def update_screen(self, simulator=None, map=None, airport_manager=None, sidebar=None, toolbar=None):
		self.refresh_background()
		map.draw_map(self.__display)
		airport_manager.draw_airport(self.__display,  map=map, simulator=simulator)
		toolbar.draw_toolbar(self.__display, simulated_datetime=simulator.get_simulated_datetime())
		sidebar.draw_sidebar(self.__display)
