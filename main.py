...
def simulate(screen, toolbar, sidebar, airport_manager, map_, simulator, plane_manager, collision_detector):
	run = True
	while run:
		...
		screen.update_screen(simulator=simulator, toolbar=toolbar, sidebar=sidebar, airport_manager=airport_manager,
			map_=map_, plane_manager = plane_manager, collision_detector=collision_detector)
...
if __name__ == "__main__":
	...
	simulate(screen, toolbar, sidebar, airport_manager, map_, simulator, plane_manager, collision_detector)
